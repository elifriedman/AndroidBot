...
public class BluetoothSerialService {
    ...
    /**
     * Start a secure ConnectThread to initiate a connection to a remote device.
     * Use this as default?...
     *
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            this.setName("AcceptThread" + mSocketType);
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket, String socketType) {
            if (D) Log.i(TAG, "create ConnectedThread: " + socketType);
            mmSocket = socket;
